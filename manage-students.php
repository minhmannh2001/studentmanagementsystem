                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                            ...
                            echo "<h5 style='margin-top: 20px;'>Total Students: $nb_students</h5>";
                        ?>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach ($students as $student) {
                                                ...
                                                $student_start_date = $student['user_start_date'];
                                                $student_start_date = date_create($student_start_date);
                                                $student_start_date = date_format($student_start_date, "d/m/Y");
                                                echo "
                                                <tr>
                                                    <td>$count</td>
                                                    <td>$student_id</td>
