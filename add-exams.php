                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <form action="action_page.php">
                                                ...
                                                <input required="true" type="text" id="examtitle" name="examtitle" style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; margin-top: 6px; margin-bottom: 16px; resize: vertical;">
                                                ...
                                                <input required="true" type="file" id="examsubject" name="examsubject" style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; margin-top: 6px; margin-bottom: 16px; resize: vertical;">

                                                <label for="examexpirationdate">Expiration Date</label>
                                                <input type="date" id="examexpirationdate" name="examexpirationdate" style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; margin-top: 6px; margin-bottom: 16px; resize: vertical;">
