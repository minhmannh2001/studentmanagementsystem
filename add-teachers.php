<?php
    ...
    try {
        ...
        if (isset($_POST['submit']) and $error=="") {
            ...
            $student_position = 'Teacher';
            $stmt->bindParam(':user_position', $student_position);
            $stmt->execute();

            $stmt = $conn->prepare("SELECT * FROM Users WHERE user_account = :student_account");
            $stmt->bindParam(':student_account', $student_account);
            $stmt->execute();
            ...
            $stmt->bindParam(':class_homeroom_teacher_id', $teacher_id);
            $stmt->bindParam(':class_name', $student_class);
            $stmt->execute();
...
<html lang="en">
    <head>
        ...
        <title>Add Teachers - Student Management System</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <form action="<?php $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" method="POST">
                                                ...
                                                <label for="studentphoto">Teacher Photo</label>
                ...
                <div id="snackbar">Add new teacher successfully.</div>
