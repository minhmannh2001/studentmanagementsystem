                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM ParticipantList WHERE list_id=:list_id AND participant_id=:participant_id AND exam_submission IS NOT NULL;");
                                    $stmt->bindParam(':list_id', $exam_list_id);
                                    $stmt->bindParam(':participant_id', $exam_participant_id);
                                    $stmt->execute();
                                    ...
                                    if (count($result) == 0) {
                                        ...
                                        $submission_file = $result[0]['exam_submission'];
                                        echo "You have submitted. Click <a href='download.php?path=submission/$submission_file'>here</a> to download your work.";
                                        echo "<br>Or click <a href='resend-exam-submission.php'>here</a> to replace your work.";
                                    }
                                ?>
                            </div>
                        </div>
